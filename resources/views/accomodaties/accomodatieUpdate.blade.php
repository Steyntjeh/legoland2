    ...
    <main>
        ...
        <form action="{{ route('accomodaties.update', $accomodatie['id']) }}" method="post">
         ...
         <div class="form-group">
            ...
            <textarea type="text" name="informatie" class="form-control" placeholder="Informatie...">{{ $accomodatie['informatie'] }}</textarea>
         </div>
         <div class="form-group">
            <label for="facilities">Faciliteiten*</label>
            <textarea type="text" name="facilities" class="form-control" placeholder="Faciliteiten...">{{ $accomodatie['facilities'] }}</textarea>
         </div>
         <div class="form-group">
